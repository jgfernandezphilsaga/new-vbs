...
Route::get('/review_dispatcher/{header_id}', [RequestController::class, 'show_request_details_dispatcher']);
...
Route::post('/users/{id}/toggle-active', [UserController::class, 'toggleActive'])->name('user.toggleActive');
...
Route::middleware(['auth', 'auth.session'])->group(function () {
    ...
    Route::get('/api/get_approvers', [RequestController::class, 'select_approvers']);
