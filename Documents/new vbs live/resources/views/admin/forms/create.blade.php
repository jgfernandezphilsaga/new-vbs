                            ...
                            @for($i = 0; $i < 1; $i++)
                                <tr class="data-row" data-row-id="{{ $i }}">
                                    ...
                                    <td>
                                        ...
                                        <input type="datetime-local" id="start_datetime" class="form-control form-input small-datetime" name="start_datetime[]" required />
                                    </td>
                                    <td>
                                        <input type="datetime-local" id="end_datetime" class="form-control form-input small-datetime" name="end_datetime[]" required />
                                        <input type="hidden" id="requested_hrs" name="requested_hrs[]" value=""/>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-input" name="destination_from[]" style="width:120px; font-size:13px;" required/>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-input" name="destination_to[]" style="width:120px; font-size:13px;" required/>
                                    </td>
                                    <td id="trip-type-col">
                                        <select class="form-select form-input trip-select" name="trip_type[]" style="width:120px; font-size: 13px;" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addBtn.addEventListener('click', function () {
        ...
        newRow.innerHTML = `
            ...
            <td>
                <input type="datetime-local" class="form-control form-input small-datetime" name="start_datetime[]" style="width: 180px; padding: 4px; font-size:13px;"/>   
            </td>
            <td>
                <input type="datetime-local" class="form-control form-input small-datetime" name="end_datetime[]"  style="width: 180px; padding: 4px; font-size:13px;"/>
                <input type="hidden" id="requested_hrs" class="form-control form-input " name="requested_hrs[]"  value="" style="width:100%; font-size:13px;"/>
            </td>
            <td>
                <input type="text" class="form-control form-input" name="destination_from[]" value="" style="width:120px; font-size:13px;" required/>
            </td>
            <td>
                 <input type="text" class="form-control form-input" name="destination_to[]" value="" style="width:120px; font-size:13px;" required/>
            </td>
            <td>
                <select class="form-select form-input trip-select" name="trip_type[]" style="width:120px; font-size:13px;" required>
                                                    <option value="">Select a trip type</option>
