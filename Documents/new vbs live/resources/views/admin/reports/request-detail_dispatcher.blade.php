    ...
    <div class="card p-2">
        ...
        @foreach($request_headers as $request_header)
            @php
                ...
                $request_details = $details_by_header->get($request_header->id, collect());

  
                $excess_rows = max(0, 5 - $request_details->count());

 
                $requestor      = $request_header->user_fullname;
                $dept_approver  = $request_header->dept_approver_fullname;
                $gsd_dispatcher = $request_header->gsd_manager_fullname;


                $requestedVehicles = $request_details->pluck('vehicle_type')->filter()->unique()->implode(', ');
            @endphp
                    ...
                    <div class="col-md-6 d-flex flex-column" style="text-align:end">
                        <div class="d-flex flex-row" style="text-align:end">
                            ...
                            <div class="placeholder-glow mx-2">
                                <span class="" id="header-date" style="width: 15em">
                                    {{ date('Y-m-d', strtotime($request_header->created_at)) }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="placeholder-glow mx-2">
                                <span class="" id="requested-vehicle" style="width: 15em">
                                    {{ $requestedVehicles }}
                                </span>
                            </div>
                        </div>
                            ...
                            <tbody id="modal-tbody">
                                    ...
                                    <tr>
                                        <td class="p-1">
                                            <div class="placeholder-glow mx-2 flex-grow-1" style="text-align:center">
                                                <span class="w-100">{{ date('Y-m-d', strtotime($detail->departure_time)) }}</span>
                                            </div>
                                        </td>
                                        <td class="p-1">
                                            <div class="placeholder-glow mx-2 flex-grow-1" style="text-align:center">
                                                <span class="w-100">{{ date('h:i A', strtotime($detail->departure_time)) }}</span>
                                            </div>
                                        </td>
                                        <td class="p-1">
                                            <div class="placeholder-glow mx-2 flex-grow-1" style="text-align:center">
                                                <span class="w-100">{{ $detail->requested_hrs }}</span>
                                            </div>
                                        </td>
                                        <td class="p-1">
                                            <div class="placeholder-glow mx-2 flex-grow-1 flex-shrink-0" style="text-align:center">
                                                <span class="w-100">{{ $detail->destination_from }}</span>
                                            </div>
                                        </td>
                                        <td class="p-1">
                                            <div class="placeholder-glow mx-2 flex-grow-1 flex-shrink-0" style="text-align:center">
                                                <span class="w-100">{{ $detail->destination_to }}</span>
                                            </div>
                                        </td>
                                        <td class="p-1">
                                            <div class="placeholder-glow mx-2 flex-grow-1" style="text-align:center">
                                                <span class="w-100">
                                                    @php
                                                        ...
                                                        foreach($holder as $value) {
                                                            $temp = explode('|', $value);
                                                            $passengers .= $temp[1] ?? '';
                                                            if(end($holder) != $value) $passengers .= '&nbsp;';
                                                        }
                                                    @endphp
                                                    {!! $passengers !!}
                                                </span>
                                ...
                                @if($excess_rows > 0)
                                    @for($count = 0; $count < $excess_rows; $count++)
                                        <tr>
                                            <td class="p-1"><div class="mx-2">&nbsp;</div></td>
                                            <td class="p-1"><div class="mx-2">&nbsp;</div></td>
                                            <td class="p-1"><div class="mx-2">&nbsp;</div></td>
                                            <td class="p-1"><div class="mx-2">&nbsp;</div></td>
                                            <td class="p-1"><div class="mx-2">&nbsp;</div></td>
