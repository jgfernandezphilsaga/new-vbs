        ...
        $('#requestDetailModal').on('show.bs.modal', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let header_values = response?.request_details ?? null;
                    ...
                    if (!header_values) {
                        console.log('request_details is null:', response);

                        $confidential.hide();
                        $emergency.hide();

                        $statusSpan.removeClass().addClass('badge bg-secondary').text('NO DATA');

                        $("#driver-details").text("TBA");
                        $("#actual-vehicle").text("TBA");
                        $("#requested-vehicle").text("TBA");

                        $("#reference-id").removeClass("placeholder").text("N/A");
                        $("#reference-origin").removeClass("placeholder").text("N/A");
                        $("#requesting-dept").removeClass("placeholder").text("N/A");
                        $("#header-date").removeClass("placeholder").text("N/A");

                        $("#purpose").removeClass("placeholder").text("N/A");
                        $("#purpose1").text("N/A");
                        $("#requested-by").removeClass("placeholder").text("N/A");
                        $("#approved-by").removeClass("placeholder").text("N/A");
                        $("#acknowledged-by").removeClass("placeholder").text("N/A");
                        $("#acknowledged-by-division").text("N/A");
                    ...
                    $("#requested-vehicle").text(vehicle || "TBA");
                    ...
                    $statusSpan.addClass(statusClass).text(status || 'N/A');

                    $("#reference-id").removeClass("placeholder").text(header_values?.dispatch_reference ?? '');
                    $("#reference-origin").removeClass("placeholder").text(header_values?.request_reference ?? '');
                    $("#requesting-dept").removeClass("placeholder");
                    $("#header-date").removeClass("placeholder").text(formatDate(header_values?.created_at, 'header'));
                    ...
                    $("#requested-by").text(res_requestor || 'N/A');
                    ...
                    if (remarks_values.length > 0) {
                        $('#remarks-section').append(`
                            ...
                            <div class="d-flex flex-column my-3">
                                ...
                                <div class="d-flex flex-row overflow-x-auto remarks-scrollbar" id="remarks"></div>
                            </div>
                        `);
